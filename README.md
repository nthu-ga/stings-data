...
![image](https://github.com/user-attachments/assets/11581f8e-f7eb-42a8-9db4-d795b2f65bf8)
...
The full dataset is approximately 100GB. Files are grouped into 20 `tar.gz` "batches" of 2-7 GB each. Each tarfile unpacks to the directory structure described below.
...
A very simple Jupyter notebook, `notebooks/dr1/dr1_example.ipynb` ([link](/notebooks/dr1/dr1_example.ipynb)), shows how to identify galaxies of interest and read the particle data with [h5py](https://www.h5py.org/). Please see the following description of the data model for more details.
